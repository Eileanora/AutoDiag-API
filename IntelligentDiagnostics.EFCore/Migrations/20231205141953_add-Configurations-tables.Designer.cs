...
namespace IntelligentDiagnostics.EFCore.Migrations
{
    ...
    [Migration("20231205141953_add-Configurations-tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntelligentDiagnostics.Core.Models.Error", b =>
                {
            ...
            modelBuilder.Entity("IntelligentDiagnostics.Core.Models.Parameter", b =>
                {
            ...
            modelBuilder.Entity("IntelligentDiagnostics.Core.Models.Reading", b =>
                {
            ...
            modelBuilder.Entity("IntelligentDiagnostics.Core.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntelligentDiagnostics.Core.Models.Error", b =>
                {
                    b.HasOne("IntelligentDiagnostics.Core.Models.User", "User")
                        .WithMany("errors")
            ...
            modelBuilder.Entity("IntelligentDiagnostics.Core.Models.Reading", b =>
                {
                    b.HasOne("IntelligentDiagnostics.Core.Models.Parameter", "Parameter")
                        .WithMany("Readings")
                        .HasForeignKey("ParameterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IntelligentDiagnostics.Core.Models.SystemCar", "SystemCar")
                        .WithMany("Readings")
